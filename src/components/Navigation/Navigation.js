...
const Navigation = ({handleRouteChange,signedIn}) => {
  if (signedIn) {
    return (
    ...
    <svg
      ...
      <div className="flex-grow pa3 flex items-center pointer">
        ...
        onClick={() => handleRouteChange('signout')}>Sign Out</p>
      ...
      return (
        ...
        <p className="f6 link dib white dim mr3 mr4-ns"
          href="#0"
          onClick={() => handleRouteChange('signin')}>Sign In</p>

        <p className="f6 link dib white dim mr3 mr4-ns"
          href="#0"
          onClick={() => handleRouteChange('register')}>Register</p>
        </div>
        </nav>
      );
    }
